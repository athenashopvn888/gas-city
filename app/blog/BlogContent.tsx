...
const STATIC_POSTS = [
  ...
  },
  {
    ...
    title: "Why GAS CITY CANNABIS is GTA's Best Dispensary",
  ...
  },
  {
    ...
    title: "GTA Cannabis Laws in 2026 — What You Need to Know",
    excerpt: "Age limits, public consumption rules, possession limits, and where you can legally smoke in GTA. Stay informed.",
    date: "2026-04-25",
    category: "News",
    emoji: "⚖️",
    readTime: "4 min",
...
/* ── Google Reviews ── */
const REVIEWS = [
  { name: "Mike R.", rating: 5, text: "Best dispensary in the GTA area. Staff is super knowledgeable and the exotic strains are legit fire.", date: "2 weeks ago" },
...
export default function BlogContent() {
  ...
  useEffect(() => {
    fetch(`${APPS_SCRIPT_URL}?action=blog&store=GCC01`)
      .then((r) => r.json())
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <h1 className={styles.heroH1}>
            📝 GAS CITY CANNABIS <span className={styles.heroAccent}>Blog</span>
          </h1>
          <p className={styles.heroSub}>
            Cannabis guides, strain reviews, and dispensary news from GTA&apos;s
            premium dispensary.
          </p>
        </div>
      </section>
      ...
      <section className={styles.ctaSection}>
        <div className={styles.ctaInner}>
          ...
          <p className={styles.ctaSub}>
            200+ strains · Exotic to Budget · Open Daily: 10:00 AM - 03:00 AM
          </p>
