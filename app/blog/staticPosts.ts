...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "Is GAS CITY CANNABIS the Right Weed Dispensary in Toronto for Your Visit?",
    "seoTitle": "GAS CITY CANNABIS Weed Dispensary in Toronto | Visit Guide",
    "seo_title": "GAS CITY CANNABIS Weed Dispensary in Toronto | Visit Guide",
    "metaDescription": "Plan a Toronto visit to GAS CITY CANNABIS with store-page checks, menu categories, and practical next steps for adults 19+.",
    "meta_description": "Plan a Toronto visit to GAS CITY CANNABIS with store-page checks, menu categories, and practical next steps for adults 19+.",
    "h1": "Is GAS CITY CANNABIS the Right Weed Dispensary in Toronto for Your Visit?",
    "excerpt": "A practical Toronto visit guide for adults 19+ checking GAS CITY CANNABIS.",
  ...
  },
  {
    ...
    "title": "GAS CITY CANNABIS Flower Guide: Budget, Premium and Exotic Sections",
    "seoTitle": "GAS CITY CANNABIS Flower Guide | Toronto Budget to Exotic",
    "seo_title": "GAS CITY CANNABIS Flower Guide | Toronto Budget to Exotic",
    "metaDescription": "Compare GAS CITY CANNABIS flower sections including Budget, AA, AAA+, Premium, and Exotic with current-menu checks and natural value wording.",
    "meta_description": "Compare GAS CITY CANNABIS flower sections including Budget, AA, AAA+, Premium, and Exotic with current-menu checks and natural value wording.",
    "h1": "GAS CITY CANNABIS Flower Guide: Budget, Premium and Exotic Sections",
    "excerpt": "A clear flower guide for GAS CITY CANNABIS, from cheap weed and budget weed searches to premium flower and exotic flower browsing.",
    "authorName": "Mika Lane",
    "authorHandle": "@MikaGasCity",
    "authorRole": "House Writer",
    "author": "Mika Lane",
  ...
  },
  {
    ...
    "title": "GAS CITY CANNABIS Menu Guide: Flower, Pre-Rolls, Edibles, THC Vapes and More",
    "seoTitle": "GAS CITY CANNABIS Menu Guide | Toronto Weed Store Categories",
    "seo_title": "GAS CITY CANNABIS Menu Guide | Toronto Weed Store Categories",
    "metaDescription": "Use this GAS CITY CANNABIS menu guide to browse flower sections, pre-rolls, edibles, THC vapes, concentrates, accessories, and store details before visiting.",
    "meta_description": "Use this GAS CITY CANNABIS menu guide to browse flower sections, pre-rolls, edibles, THC vapes, concentrates, accessories, and store details before visiting.",
    "h1": "GAS CITY CANNABIS Menu Guide: Flower, Pre-Rolls, Edibles, THC Vapes and More",
    "excerpt": "A practical Toronto menu guide for GAS CITY CANNABIS, with natural category paths for adults 19+.",
    "authorName": "Gavin City",
    "authorHandle": "@GavinGasCity",
    "authorRole": "House Writer",
    "author": "Gavin City",
