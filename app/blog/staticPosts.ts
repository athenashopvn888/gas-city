...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "How to Plan a GAS CITY CANNABIS Visit Without Guessing",
    "seoTitle": "GAS CITY CANNABIS Visit Guide | Weed Dispensary in Toronto",
    "seo_title": "GAS CITY CANNABIS Visit Guide | Weed Dispensary in Toronto",
    "metaDescription": "Plan a Toronto visit to GAS CITY CANNABIS with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "meta_description": "Plan a Toronto visit to GAS CITY CANNABIS with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "h1": "How to Plan a GAS CITY CANNABIS Visit Without Guessing",
    "excerpt": "A practical visit guide for GAS CITY CANNABIS, written for shoppers who want the next step without the runaround.",
  ...
  },
  {
    ...
    "seoTitle": "GAS CITY CANNABIS Flower Guide | Budget to Exotic",
    "seo_title": "GAS CITY CANNABIS Flower Guide | Budget to Exotic",
    "metaDescription": "Compare GAS CITY CANNABIS flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "meta_description": "Compare GAS CITY CANNABIS flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "h1": "How to Compare GAS CITY CANNABIS Flower Without Guessing",
    "excerpt": "A shopper-first flower guide for comparing Budget, AA, AAA+, Premium, and Exotic sections at GAS CITY CANNABIS.",
    "authorName": "Mika Lane",
    "authorHandle": "@MikaGasCity",
    "authorRole": "House Writer",
    "author": "Mika Lane",
  ...
  },
  {
    ...
    "seoTitle": "GAS CITY CANNABIS Menu Guide | Toronto Weed Store",
    "seo_title": "GAS CITY CANNABIS Menu Guide | Toronto Weed Store",
    "metaDescription": "Shop the GAS CITY CANNABIS menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "meta_description": "Shop the GAS CITY CANNABIS menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "h1": "How to Shop the GAS CITY CANNABIS Menu Like a Pro",
    "excerpt": "A natural guide to shopping the GAS CITY CANNABIS menu without turning the visit into a guessing game.",
    "authorName": "Gavin City",
    "authorHandle": "@GavinGasCity",
    "authorRole": "House Writer",
    "author": "Gavin City",
