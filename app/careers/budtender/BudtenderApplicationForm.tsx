...
const requiredFields = [
  ...
  { name: "WhyQLC", label: "Why you want to work at Gas City" },
...
export default function BudtenderApplicationForm() {
  ...
  return (
    <form className={styles.applicationForm} onSubmit={handleSubmit} noValidate>
      <input type="hidden" name="StoreKey" value="GCC01" />
      <input type="hidden" name="StoreName" value="GAS CITY CANNABIS" />
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>Why do you want to work at GAS CITY CANNABIS?</span>
