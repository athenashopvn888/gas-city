...
export default function AgeGate() {
  ...
  useEffect(() => {
    ...
    const verified = localStorage.getItem("GCC01_age_verified");
    if (verified !== "true") {
      setShow(true);
    }
  }, []);
  ...
  const handleVerify = () => {
    localStorage.setItem("GCC01_age_verified", "true");
    setShow(false);
  };
          ...
          <div className={styles.promptState}>
            <div className={styles.logoWrap}>
              <img
                ...
                alt="GAS CITY CANNABIS"
                className={styles.logo}
              />
            </div>
            <h2 className={styles.title}>Age Verification</h2>
            <p className={styles.text}>
              GAS CITY CANNABIS requires all visitors to be of legal age.
