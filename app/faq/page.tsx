...
export const metadata: Metadata = {
  title: "FAQ — GAS CITY CANNABIS | GTA Dispensary Questions",
  description:
    "Frequently asked questions about GAS CITY CANNABIS in GTA. Hours, location, products, pricing, bundle offers, and everything you need to know before visiting.",
  alternates: {
    canonical: "https://gascitycannabis.com/faq",
  },
};
...
const FAQ_CATEGORIES = [
  {
    ...
    faqs: [
      { q: "Where is GAS CITY CANNABIS located?", a: "We are located at 985 O'Connor Dr, GTA, ON M4B 2T1. We're easily accessible by TTC bus routes and close to major highways like the 401." },
      ...
      { q: "What's the best way to get to GAS CITY CANNABIS?", a: "We're easily accessible by car, bus, or foot. We are easily accessible by car, local transit, or bus routes. Free parking is available on surrounding streets." },
    ],
  },
  {
    title: "🌿 Products & Menu",
    faqs: [
      ...
      { q: "Do you have a live menu?", a: "Yes! Our online menu at gascitycannabis.com updates in real time with current stock, prices, THC levels, and availability. You can check what's in stock before you visit." },
      ...
      { q: "Do you sell native cigarettes?", a: "Yes! We carry one of the widest selections of native cigarettes in downtown GTA, including premium and value brands in multiple varieties." },
    ],
  },
  {
    title: "💰 Pricing & Bundle Offers",
    faqs: [
      { q: "What is the cheapest weed you sell?", a: "Our Budget tier starts at $3/g with value ounces from $40. Our AA tier is $4/g. These are the most competitive prices you'll find in GTA." },
  ...
  },
  {
    ...
    faqs: [
      { q: "Do I need an appointment?", a: "No! GAS CITY CANNABIS is walk-in only. Just show up anytime — we are open daily from 10:00 AM to 03:00 AM." },
      { q: "Can I order online?", a: "Currently, GAS CITY CANNABIS is an in-store shopping experience only. You can browse our live menu online to see what's in stock before visiting." },
      ...
      <main className={styles.main}>
        ...
        <section style={{ width: "100%", overflow: "hidden", marginTop: "92px" }}>
          <img
            ...
            alt="GAS CITY CANNABIS FAQ — Your Questions Answered"
        ...
        <div className={styles.content}>
          ...
          <p className={styles.pageSubtitle}>
            Everything you need to know about GAS CITY CANNABIS — GTA&apos;s premium dispensary at 985 O'Connor Dr in GTA.
          </p>
          ...
          <div className={styles.ctaSection}>
            ...
            <p className={styles.ctaText}>
              Call us at <strong>(647) 638-1494</strong> or visit us at 985 O'Connor Dr, GTA.
            </p>
          </div>
        </div>
        <Footer />
