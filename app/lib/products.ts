...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    faqs: [
      ...
      { q: "Can I buy edibles at GAS CITY CANNABIS?", a: "Yes! Visit us at 985 O'Connor Dr, GTA. We're open daily 24 hours with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
  ...
  PREROLLS: {
    ...
    seoDescription: "Skip the rolling and grab a pre-roll from GAS CITY CANNABIS in GTA. We carry singles, multi-packs, and infused pre-rolls from premium flower. Whether you want a quick smoke or a party pack, our pre-roll selection has something for everyone. Visit us at 985 O'Connor Dr — open daily 24 hours.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    seoDescription: "GAS CITY CANNABIS is your go-to source for affordable native cigarettes in GTA. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 985 O'Connor Dr in the heart of ByWard Market, we're open daily 24 hours. Stop by for the best cigarette prices in the neighbourhood.",
    faqs: [
      ...
      { q: "Are your cigarette prices competitive?", a: "Absolutely. We offer some of the best cigarette prices in the ByWard Market area of GTA." },
    ],
  },
  "MAGIC & OTHERS": {
