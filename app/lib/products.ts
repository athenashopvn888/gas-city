...
export async function fetchLiveProducts(): Promise<{
  ...
  try {
    const res = await fetch(`${APPS_SCRIPT_URL}?store=GCC01`, {
...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoIntro: "Browse the full cannabis edibles menu at GAS CITY CANNABIS on GTA St, GTA. We carry THC gummies, chocolates, drinks, and more from top Canadian brands.",
    seoDescription: "Looking for cannabis edibles in GTA? GAS CITY CANNABIS stocks a wide range of THC-infused gummies, chocolates, beverages, and baked goods. Our edibles range from micro-dose options for beginners to high-potency products for experienced consumers. All products are lab-tested and sourced from licensed Canadian producers. Visit us at 985 O'Connor Dr — we are Open Daily: 10:00 AM - 03:00 AM.",
    faqs: [
      ...
      { q: "Can I buy edibles at GAS CITY CANNABIS?", a: "Yes! Visit us at 985 O'Connor Dr, GTA. We're open daily from 10:00 AM to 03:00 AM with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
    ...
    seoIntro: "Shop THC and nicotine vape pens at GAS CITY CANNABIS, GTA. Cartridges, 510-thread batteries, and premium vape brands — all in stock.",
    seoDescription: "GAS CITY CANNABIS carries a curated selection of vape pens and cartridges in GTA. From 510-thread THC cartridges to nicotine vape pods, we stock the most popular brands and flavours. Our knowledgeable budtenders can help you choose the right cartridge and battery setup. Visit us at 985 O'Connor Dr for the best vape selection in ByWard Market.",
    faqs: [
  ...
  "VAPE DISPOSABLE": {
    ...
    seoIntro: "THC disposable vapes available at GAS CITY CANNABIS, GTA. No charging, no refilling — just open and enjoy.",
    seoDescription: "Disposable THC vapes are the easiest way to enjoy cannabis on the go. GAS CITY CANNABIS stocks a wide selection of pre-charged, pre-filled disposable vape pens with various strain profiles and potencies. Perfect for beginners and experienced users alike. Visit us at 985 O'Connor Dr, GTA.",
    faqs: [
  ...
  CONCENTRATES: {
    ...
    seoIntro: "Premium cannabis concentrates at GAS CITY CANNABIS, GTA. Shatter, wax, hash, live resin, and diamonds — all in stock.",
    seoDescription: "GAS CITY CANNABIS offers a premium selection of cannabis concentrates in GTA. From traditional hash and kief to modern extracts like shatter, wax, live resin, and THC diamonds, we carry products for every preference and potency level. Our concentrates are sourced from trusted extractors and tested for purity. Visit us at 985 O'Connor Dr.",
    faqs: [
  ...
  PREROLLS: {
    ...
    seoIntro: "Pre-rolled cannabis joints at GAS CITY CANNABIS, GTA. Singles, multi-packs, and infused pre-rolls — ready to light up.",
    seoDescription: "Skip the rolling and grab a pre-roll from GAS CITY CANNABIS in GTA. We carry singles, multi-packs, and infused pre-rolls from premium flower. Whether you want a quick smoke or a party pack, our pre-roll selection has something for everyone. Visit us at 985 O'Connor Dr — we are Open Daily: 10:00 AM - 03:00 AM.",
    faqs: [
  ...
  "ADD ONS": {
    ...
    seoIntro: "Essential cannabis accessories at GAS CITY CANNABIS, GTA. Grinders, rolling papers, lighters, trays, and more.",
    seoDescription: "GAS CITY CANNABIS carries all the accessories you need for the perfect smoke session. From premium grinders and rolling papers to lighters, trays, and storage containers, we have everything in stock. Visit us at 985 O'Connor Dr, GTA.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    seoTitle: "Native Cigarettes GTA — Discount Tobacco at GAS CITY CANNABIS",
    seoIntro: "Discount native cigarettes at GAS CITY CANNABIS, GTA. Premium and value brands at the best prices on GTA St.",
    seoDescription: "GAS CITY CANNABIS is your go-to source for affordable native cigarettes in GTA. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 985 O'Connor Dr in the heart of 985 O'Connor Dr & Nearby Expressway, we're Open Daily: 10:00 AM - 03:00 AM.",
    faqs: [
      { q: "Do you sell cigarettes at GAS CITY CANNABIS?", a: "Yes! We carry a wide selection of native cigarette brands at competitive prices." },
      ...
      { q: "Are your cigarette prices competitive?", a: "Absolutely. We offer some of the best cigarette prices in the 985 O'Connor Dr & Nearby Expressway area of GTA." },
    ],
  },
  "MAGIC & OTHERS": {
    ...
    seoIntro: "Magic mushrooms, psilocybin products, and specialty items at GAS CITY CANNABIS, GTA.",
    seoDescription: "GAS CITY CANNABIS carries a curated selection of magic mushrooms and specialty products in GTA. From micro-dose capsules to dried psilocybin mushrooms, we stock products for both beginners and experienced psychonauts. Visit us at 985 O'Connor Dr for our full selection.",
    faqs: [
