    ...
    "sections": [
      {
        ...
        "body": "When you search for a weed store near East York / O'Connor, open the Gas City Cannabis store page first. Confirm directions, contact options, listed hours, and the menu path before visiting."
      },
      {
    ...
    "sections": [
      {
        ...
        "body": "A near-me search should get you to the right store page, not a wall of generic copy. Gas City Cannabis gives shoppers a clear path to the store page, menu categories, and resources."
      },
      {
