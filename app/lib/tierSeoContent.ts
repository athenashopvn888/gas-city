  ...
  BUDGET: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Budget flower starts at just $3 per gram. Value ounces start from $40 — some of the best prices you'll find in GTA. Our Buy 2g Get 1g FREE promo applies here too, giving you even more savings.",
      },
    ],
    faqs: [
