"""
GAS CITY CANNABIS - Auto Sync from Google Sheets
==========================================
...
a filtered menu for GAS CITY CANNABIS (ALC01).
...
def main():
    print("=" * 60)
    print(f"  GAS CITY CANNABIS - Product Sync (Store: {STORE_CODE})")
    print("=" * 60)
    print()
    ...
    if do_deploy:
        ...
        if result.returncode == 0:
            print("  [OK] Live at https://gascitycannabis.com")
        else:
            print(f"  Output:\n{result.stdout[-500:]}")
    else:
