"""
GAS CITY CANNABIS — Product Update Script
===================================
Drop your ONHAND CSV into the gas-city folder as "onhand.csv" and run:
...
def main():
    ...
    if not os.path.exists(csv_path):
        print("=" * 60)
        print("  GAS CITY CANNABIS — Product Updater")
        print("=" * 60)
        print()
    ...
    if ans in ("y", "yes"):
        ...
        print("\n  [OK] Deployed! Check https://gascitycannabis.com")
    else:
